...
export const DEFAULT_CONTENTDOCUMENT_FILENAME = 'ContentDocument_Export_{timestamp}.zip'
export const DEFAULT_ATTACHMENT_FILENAME      = 'Attachment_Export_{timestamp}.zip'
